...
int main(int argc, char *argv[])
{
    ...
    // ====================================================================
    // === ВОТ СТРОКА, КОТОРАЯ ВСЁ ИСПРАВЛЯЕТ ===
    // Мы говорим приложению, чтобы оно НЕ завершалось автоматически,
    // когда последнее окно закрывается. Теперь оно закроется только
    // по команде QApplication::quit() (которая вызывается кнопкой "Выход на рабочий стол").
